...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(URL)
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("wagner@wbn.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("12345"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua do Wagner"))
    ...
    @Test
    fun `should find customer by id and return status`() {
        // given
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(MockMvcRequestBuilders
            ...
            .content(valueAsString))
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Wagner Braz"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Nogueira"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28572444017"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("wagner@wbn.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("5000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("45656"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Av Novo Wagner 542"))
            //.andExpect(MockMvcResultMatchers.jsonPath("$.id").value(1))
            .andDo(MockMvcResultHandlers.print())
    }
    ...
    private fun builderCustomerDto(
        ...
        email: String = "wagner@wbn.com",
        income: BigDecimal = BigDecimal.valueOf(1000.0),
        password: String = "123456",
        zipCode: String = "12345",
        street: String = "Rua do Wagner"
    ): CustomerDto {
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "Wagner Braz",
        lastName: String = "Nogueira",
        income: BigDecimal = BigDecimal.valueOf(5000.0),
        zipCode: String = "45656",
        street: String = "Av Novo Wagner 542"
